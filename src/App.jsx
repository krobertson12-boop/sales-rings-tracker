                          ...
                          {(() => {
                            ...
                            return (
                              <>
                                ...
                                {/* Y axis left */}
                                <line x1="40" y1="0" x2="40" y2="280" stroke="#000" strokeWidth="1.5" />
                                
                                {/* Y axis right */}
                                <line x1="630" y1="0" x2="630" y2="280" stroke="#000" strokeWidth="1.5" />
                                
                                {/* Y axis labels right only */}
                                {yScale.labels.map((label, i) => (
                                  <text key={`y-right-${i}`} x="645" y={273-i*45} fontSize="11" fontWeight="600" textAnchor="start" fill="#000">{label}</text>
                                ))}
